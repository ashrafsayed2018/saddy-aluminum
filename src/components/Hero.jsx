    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
          ...
          <span className='text-white'>  السعدي للالمنيوم والزجاج والستالستيل</span>
        ...
        <div className='flex flex-row justify-between items-center w-full text-right'>
          ...
          افضل شركة<br className='sm:block hidden'/> {" "}
            <span className='text-gradient'>  للالمنيوم</span> {" "}
          </h1>
        ...
        نقدم لكم جميع أعمال الألمنيوم بدقة واحترافية عالية.

<br />
  <span >
  واجهات ألمنيوم وزجاج مرتفعة </span>
  <p >
  تنفيذ أبواب ونوافذ ألمنيوم أسود  </p>
        </p>
      </div>
