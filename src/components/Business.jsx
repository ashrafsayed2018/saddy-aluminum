  ...
  return (
    <section id='features' className={`${layout.section} `} >
      <div className={layout.sectionInfo}>
        ...
        خدمات أعمال الألمنيوم والاستانلس ستيل، بما في ذلك تصميم وتصنيع الأبواب والنوافذ، وواجهات المباني، والسلالم والدرابزينات، والأبواب والحواجز الزجاجية، والأثاث والتجهيزات الداخلية.
